...
class ValidationTest {
    ...
    void testAdvancedValidate1() {
        ...
        assertThat(notValidFields.toString()).isEqualTo("{country=[length less than 4], street=[can not be null]}");
    }

    @Test
    void testAdvancedValidate2() {
        Address address = new Address("USAA", "Texas", "Street", "7", null);
        Map<String, List<String>> notValidFields = Validator.advancedValidate(address);
        assertThat(notValidFields.toString()).isEqualTo("{}");
    }

    @Test
    void testAdvancedValidate3() {
        Address address = new Address(null, "Te", "Street", "7", null);
        Map<String, List<String>> notValidFields = Validator.advancedValidate(address);
        assertThat(notValidFields.toString()).isEqualTo("{country=[can not be null]}");
    }
    // END
}
