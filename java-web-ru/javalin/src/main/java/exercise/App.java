    ...
    private static void addRoutes(Javalin app) {
        ...
        app.routes(() -> {
            path("articles", () -> {
                ...
                path("new", () -> get(ArticleController.newArticle));
                path("{id}", () -> {
                    get(ArticleController.showArticle);
                    path("edit", () -> get(ArticleController.editArticle));
                    path("edit", () -> post(ArticleController.updateArticle));
                    path("delete", () -> get(ArticleController.deleteArticle));
                    path("delete", () -> post(ArticleController.destroyArticle));
